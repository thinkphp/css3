...
var yahoofight = (function(){

    var yahooAPI = 'http://search.yahooapis.com/WebSearchService/V1/webSearch?appid=YahooDemo&callback=yahoofight.incoming&output=json&query=',
        results = [], val1, val2, 
    ...
    function incoming(o) {
        ...
        if(window.location) console.log(o);

        if(o.ResultSet) {
           results.push({
             term: o.ResultSet.type,
